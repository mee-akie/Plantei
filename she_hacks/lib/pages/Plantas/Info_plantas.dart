...
List<Info_planta> plantas = [
  Info_planta(1,
      name: 'Alface',
      iconImage: 'assets/imagens/alface.jpg',
      description:
  ...
  Info_planta(4,
      name: 'Planta 1',
      iconImage: 'assets/imagens/mars.png',
      description:
  ...
  Info_planta(5,
      name: 'Planta 1',
      iconImage: 'assets/imagens/jupiter.png',
      description:
  ...
  Info_planta(6,
      name: 'Planta 1',
      iconImage: 'assets/imagens/saturn.png',
      description:
  ...
  Info_planta(7,
      name: 'Planta 1',
      iconImage: 'assets/imagens/uranus.png',
      description:
  ...
  Info_planta(8,
      name: 'Planta 1',
      iconImage: 'assets/imagens/neptune.png',
      description:
